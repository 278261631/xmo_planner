...
def write_jgg_plan_file(template_file, jgg_list, dest_file, item_template):
    try:
        ...
        for i in range(len(jgg_list)):
            ...
            new_line = re.sub(r"replace_ra_deg_1", "{:6f}".format(jgg_list[i][0][0]/15), new_line)
            new_line = re.sub(r"replace_ra_deg_2", "{:6f}".format(jgg_list[i][1][0]/15), new_line)
            new_line = re.sub(r"replace_ra_deg_3", "{:6f}".format(jgg_list[i][2][0]/15), new_line)
            new_line = re.sub(r"replace_ra_deg_4", "{:6f}".format(jgg_list[i][3][0]/15), new_line)
            new_line = re.sub(r"replace_ra_deg_5", "{:6f}".format(jgg_list[i][4][0]/15), new_line)
            new_line = re.sub(r"replace_ra_deg_6", "{:6f}".format(jgg_list[i][5][0]/15), new_line)
            new_line = re.sub(r"replace_ra_deg_7", "{:6f}".format(jgg_list[i][6][0]/15), new_line)
            new_line = re.sub(r"replace_ra_deg_8", "{:6f}".format(jgg_list[i][7][0]/15), new_line)
            new_line = re.sub(r"replace_ra_deg_9", "{:6f}".format(jgg_list[i][8][0]/15), new_line)
